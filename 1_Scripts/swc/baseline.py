...
def predict(lang, mode = "dev", train_file = f"../../dataset/swc.train.tsv"):
    ...
    if mode == "dev":
        # print(gold[:10])
        print(f"TRAINING FILE: {train_file} METRIC: {evaluate(pred, gold)}")
        print()
...
def main():
    ...
    predict(lang=lang, mode = mode, train_file = train_file)
